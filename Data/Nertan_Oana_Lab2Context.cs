...
namespace Nertan_Oana_Lab2.Data
{
    public class Nertan_Oana_Lab2Context : DbContext
    {
        ...
        public DbSet<Nertan_Oana_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Nertan_Oana_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Nertan_Oana_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
